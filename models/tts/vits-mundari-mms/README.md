...
# Massively Multilingual Speech (MMS): Mundari Text-to-Speech

This repository contains the **Mundari (unr)** language text-to-speech (TTS) model checkpoint.
...
model = VitsModel.from_pretrained("facebook/mms-tts-unr")
tokenizer = AutoTokenizer.from_pretrained("facebook/mms-tts-unr")

text = "some example text in the Mundari language"
