...
# Massively Multilingual Speech (MMS): Ho Text-to-Speech

This repository contains the **Ho (hoc)** language text-to-speech (TTS) model checkpoint.
...
model = VitsModel.from_pretrained("facebook/mms-tts-hoc")
tokenizer = AutoTokenizer.from_pretrained("facebook/mms-tts-hoc")

text = "some example text in the Ho language"
